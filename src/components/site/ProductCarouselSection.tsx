    ...
    <section className="relative overflow-hidden">
      {bgImage ? (
        ...
        <>
          <div
            aria-hidden
            className="absolute inset-0 -z-10 bg-[radial-gradient(55%_70%_at_50%_10%,oklch(0.82_0.09_65/0.85),transparent_70%),radial-gradient(60%_55%_at_5%_95%,oklch(0.7_0.13_45/0.55),transparent_65%),radial-gradient(60%_55%_at_95%_95%,oklch(0.74_0.11_75/0.55),transparent_65%),linear-gradient(180deg,oklch(0.85_0.07_60),oklch(0.78_0.09_50))]"
          />
          <div
            aria-hidden
      ...
      <div className="max-w-7xl mx-auto px-4 py-6 md:py-9">
        <div className="text-center mb-5 md:mb-7">
          {eyebrow && (
            <div
              className={`text-xs uppercase tracking-[0.2em] ${isCream ? "text-[color:var(--gold)]" : "text-[color:var(--wood)]"}`}
            >
              {eyebrow}
            </div>
          )}
          <h2
            className={`font-display text-3xl md:text-5xl mt-1 ${isCream ? "text-[color:var(--cream)] drop-shadow-[0_2px_18px_rgba(0,0,0,0.65)]" : ""}`}
          >
            {title}
          </h2>
          {description && (
            <p
              className={`mt-3 text-sm md:text-base max-w-xl mx-auto ${isCream ? "text-[color:var(--cream)]/95 drop-shadow-[0_1px_6px_rgba(0,0,0,0.55)]" : "text-muted-foreground"}`}
            >
              {description}
            </p>
          )}
          {secondaryCta && (
            <div className="mt-6">
              ...
              >
                <span
                  aria-hidden
                  className="pointer-events-none absolute -inset-x-10 -top-10 h-16 bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.55),transparent)] blur-md translate-x-[-120%] group-hover:translate-x-[120%] transition-transform duration-[1100ms]"
                />
        ...
        {spotlight && <div className="flex justify-center">{spotlight}</div>}
        ...
        <div className="mt-8 flex justify-center">
          ...
          >
            <Sparkles
              className={`w-4 h-4 ${isCream ? "text-[color:var(--gold)]" : "text-[color:var(--gold)]"}`}
            />
            {ctaLabel}
