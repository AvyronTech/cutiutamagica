    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 pt-12 pb-16 md:pt-20 md:pb-24 grid md:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            <div className="inline-flex items-center gap-2 text-xs uppercase tracking-[0.2em] text-[color:var(--wood)] mb-5">
              <Sparkles className="w-3.5 h-3.5" /> Handmade · Gravat cu laser
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4">
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            { qty: "2", price: "150 lei", note: "75 lei/buc · transport gratuit", featured: true },
            { qty: "3", price: "225 lei", note: "75 lei/buc · transport gratuit" },
          ].map((b) => (
      ...
      <section className="max-w-7xl mx-auto px-4 py-20">
        <div className="flex items-end justify-between mb-8">
          ...
          <Link to="/produse" className="text-sm underline underline-offset-4 hover:text-foreground/80 hidden md:inline">Vezi toate →</Link>
        </div>
