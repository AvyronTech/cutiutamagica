...
import workshopBg from "@/assets/poveste-workshop.jpg";
  ...
  return (
    <div className="relative">
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(180deg, oklch(0.16 0.03 40 / 0.78) 0%, oklch(0.14 0.025 35 / 0.88) 45%, oklch(0.12 0.02 35 / 0.95) 100%)",
        }}
      />
      <div
        aria-hidden
      ...
      <div className="max-w-3xl mx-auto px-4 pt-8 text-[color:var(--cream)]">
        ...
        <article className="py-12 text-center">
          ...
          <p className="mt-8 text-lg leading-relaxed text-[color:var(--cream)]/85 mx-auto max-w-2xl">
          ...
          <p className="mt-5 text-lg leading-relaxed text-[color:var(--cream)]/85 mx-auto max-w-2xl">
          ...
          <div className="mt-14 grid sm:grid-cols-2 gap-6 text-left">
            <div className="rounded-2xl border border-[color:var(--gold)]/25 bg-[oklch(0.18_0.03_40)]/70 backdrop-blur-md p-6 shadow-[0_20px_60px_-30px_rgba(0,0,0,0.7)]">
              <h2 className="font-display text-2xl text-[color:var(--cream)]">De ce lemn?</h2>
              <p className="mt-3 text-[color:var(--cream)]/75 leading-relaxed">
          ...
          <div className="mt-14 rounded-2xl border border-[color:var(--gold)]/30 bg-[oklch(0.14_0.025_35)]/85 backdrop-blur-md p-8 shadow-warm mx-auto max-w-2xl">
            ...
            <p className="mt-2 text-sm text-[color:var(--cream)]/65">— echipa Cutiuța Magică</p>
          </div>
        </article>
      </div>
    </div>
